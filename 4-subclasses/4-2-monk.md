...
The Monk receives new features and sub-classes in this section.
...
When a creature makes an attack roll against you, you can use your reaction to make it roll 1d4 and subtract the number rolled from its attack roll. You then gain ki points equal to the number rolled.
